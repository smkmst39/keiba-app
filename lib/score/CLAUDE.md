...
| 指標           | 重み | 計算方法                                              |
|----------------|------|-------------------------------------------------------|
| 上がり3F       | 22%  | レース内順位を線形スケール（1位=100、最下位=0）       |
| 調教ラスト1F   | 18%  | レース内順位を線形スケール（速いほど高得点）          |
| 同コース成績   | 18%  | 勝率×50 + 連対率×50                                  |
| 前走クラス     | 13%  | G1=100, G2=85, G3=70, OP=55, 1勝=40, 未勝利=20      |
| 血統適性       | 12%  | 父馬の「当該コース×距離帯」連対率をレース内で正規化   |
| 馬体重増減     |  9%  | ±0=100, ±2=95, ±4=85, ±6=70, ±8=50, それ以上=30   |
| 騎手評価       |  8%  | レース内リーディング順位を線形スケール                |
